...
export default function SocialButtons() {
  return (
    <div className="fixed top-36 left-4 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="w-10 h-10 flex items-center justify-center bg-white/90 
                   text-black rounded-full shadow-lg hover:scale-110 transition"
      >
        <svg
      ...
      {/* WhatsApp */}
      <a
        href="https://wa.me/5214941032859"
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10 flex items-center justify-center bg-emerald-500 
